...
// Define some colors to be used in the game
const colors = [
...
const ColorClash: React.FC<ColorClashProps> = ({ setScore, score }) => {
  const [cards, setCards] = useState<string[]>([]); // Array of colors
  ...
  // Shuffle and create the deck of color cards
  useEffect(() => {
  ...
  return (
    <div style={styles.gameArea}>
      <h1 style={styles.title}>Color Clash</h1>
      {gameOver ? (
          ...
          <div style={styles.cardGrid}>
            {cards.map((card, index) => (
              <div
                ...
                style={{
                  ...styles.card,
                  backgroundColor: flippedIndices.includes(index) || matchedIndices.includes(index) ? card : '#888',
                }}
              >
